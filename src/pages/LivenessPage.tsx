...
export default function LivenessPage() {
    ...
    }, [pipelines, services, groups, envFilter, getPipelineHealth, getPipelineLag]);
                                ...
                                >
                                    ...
                                    <td className="px-5 py-4">
                                        <div className="font-bold flex items-center gap-2">
                                            <StatusDot status={row.health as import('@/types').ServiceStatus} pulse={row.health === 'degraded'} />
                                            {row.pipeline.name}
                                        </div>
                                    </td>
                                    <td className="px-5 py-4">
